        ...
        {({ errors, touched }) => (
          <Form className="employer-form">
            <div className="form-control-inputs">
              ...
              {errors.jobTitle && touched.jobTitle && <div className="error">{errors.jobTitle}</div>}
              ...
              {errors.jobType && touched.jobType && <div className="error">{errors.jobType}</div>}

              <label htmlFor="jobDescription">
                Job Description<span className="required">*</span>
              </label>
              <Field as="textarea" name="jobDescription" />
              {errors.jobDescription && touched.jobDescription && <div className="error">{errors.jobDescription}</div>}

              <label htmlFor="qualifications">
                Qualifications<span className="required">*</span>
              </label>
              <Field as="textarea" name="qualifications" />
              {errors.qualifications && touched.qualifications && <div className="error">{errors.qualifications}</div>}
              ...
              {errors.requirements && touched.requirements && <div className="error">{errors.requirements}</div>}
