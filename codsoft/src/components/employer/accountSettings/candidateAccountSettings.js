...
export const CandidateAccountSettings = () => {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const changesMade = Object.keys(profileData).some(key => profileData[key] !== candidateProfile[key])
    ...
    <div className="form-container">
      ...
      {edit ? (
        <form>
          ...
          <input type="text" id="gender" name="gender" value={profileData.gender} onChange={handleChange} />
